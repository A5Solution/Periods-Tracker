...
import com.example.periodflow.databinding.Example6CalendarDayBinding
import com.example.periodflow.databinding.Example6CalendarHeaderBinding
import com.example.periodflow.databinding.Example6FragmentBinding
 ...
 * ```
 * -keepclassmembers class com.example.periodflow.view.Example6MonthView {
 ...
 *  ```
 *  -keepnames class com.example.periodflow.view.Example6MonthView
 *  ```
 *  Please replace com.example.periodflow.view.Example6MonthView in the
