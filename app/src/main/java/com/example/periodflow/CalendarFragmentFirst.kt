...
import com.example.periodflow.calendar.DayViewContainer
...
class CalendarFragmentFirst : BaseFragment(R.layout.fragment_calendar_first), HasToolbar {
    override val toolbar: Toolbar? = null

    override val titleRes: Int? = null
    private val binding by lazy {
        FragmentCalendarFirstBinding.inflate(layoutInflater)
    }
