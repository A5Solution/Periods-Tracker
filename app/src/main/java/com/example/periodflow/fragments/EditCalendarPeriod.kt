...
import com.example.periodflow.databinding.Example1CalendarDayBinding
import com.example.periodflow.databinding.FragmentEditCalendarPeriodBinding
...
class EditCalendarPeriod : BaseFragment(R.layout.fragment_edit_calendar_period), HasToolbar {
    override val toolbar: Toolbar?
        get() = null

    override val titleRes: Int = R.string.example_1_title

    private lateinit var binding: FragmentEditCalendarPeriodBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentEditCalendarPeriodBinding.bind(view)
