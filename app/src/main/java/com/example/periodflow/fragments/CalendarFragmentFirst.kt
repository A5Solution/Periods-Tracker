...
import com.example.periodflow.databinding.Example4CalendarDayBinding
import com.example.periodflow.databinding.Example4CalendarHeaderBinding
import com.example.periodflow.databinding.Example4FragmentBinding
import com.example.periodflow.databinding.Example8CalendarDayBinding
import com.example.periodflow.databinding.Example8CalendarFooterBinding
import com.example.periodflow.databinding.Example8CalendarHeaderBinding
import com.example.periodflow.databinding.FragmentCalendarFirstBinding
import com.example.periodflow.shared.ContinuousSelectionHelper
import com.example.periodflow.shared.DateSelection
import com.example.periodflow.shared.dateRangeDisplayText
import com.kizitonwose.calendar.core.CalendarDay
import com.kizitonwose.calendar.core.CalendarMonth
import com.kizitonwose.calendar.core.DayPosition
import com.kizitonwose.calendar.core.daysOfWeek
import com.kizitonwose.calendar.core.yearMonth
import com.example.periodflow.shared.displayText
import com.example.periodflow.view.BaseFragment
import com.example.periodflow.view.HasBackButton
import com.example.periodflow.view.HasToolbar
import com.example.periodflow.view.addStatusBarColorUpdate
import com.example.periodflow.view.getColorCompat
import com.example.periodflow.view.getDrawableCompat
import com.example.periodflow.view.makeInVisible
import com.example.periodflow.view.makeVisible
import com.example.periodflow.view.setTextColorRes
...
class CalendarFragmentFirst : BaseFragment(R.layout.fragment_calendar_first), HasToolbar, HasBackButton {
    ...
    private lateinit var binding: FragmentCalendarFirstBinding

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        addStatusBarColorUpdate(R.color.white)
        setHasOptionsMenu(true)
        binding = FragmentCalendarFirstBinding.bind(view)
            ...
            init {
                view.setOnClickListener {
                    if (day.position == DayPosition.MonthDate &&
                        ...
                        this@CalendarFragmentFirst.binding.exFourCalendar.notifyCalendarChanged()
                        bindSummaryViews()
                    }
                }
            }
